...
export class PasswordPolicyService {
    ...
    private readonly COMMON_PASSWORDS = [
        ...
        'welcome', 'welcome123', 'letmein', 'abc123', 'monkey', 'dragon',
        'sunshine', 'princess', 'football', 'baseball', 'master', 'superman',
        'batman', 'trustno1', 'iloveyou', '111111', '123123', '1234567890',
        'qwertyuiop', 'asdfghjkl', 'zxcvbnm', 'admin123', 'adminadmin',
        'passw0rd', 'p@ssw0rd', 'Password1', 'Password123', 'qwerty123'
    ];
    ...
    private initializeCommonPasswords(): void {
        ...
        this.logger.log(`Initialized common password list with ${this.commonPasswords.size} entries`);
    }
    ...
    validatePassword(password: string): { valid: boolean; reason?: string } {
        ...
        if (this.isCommonPassword(password)) {
            return {valid: false, reason: 'Password is too common and easily guessable'};
        }
